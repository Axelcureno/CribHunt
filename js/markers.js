    ...
    var map;
            ...
            if(navigator.geolocation) {
                ...
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    var image = 'http://' +location.host + '/img/icons/geolocation.png';
                    var iconhouse = 'http://' +location.host + '/img/icons/location-red.png';
                    ...
                    for (var i = 0; i < json.length; i++) {
                        ...
                        var obj = json[i];
                        var description = '<div style="width:200px;" id="content"><a style="font-weight:bold; font-size: 1em;" href="http://' +location.host + '/' + obj.categoriacrib + '/' + obj.urlcrib + '/"><h1 style="font-weight:bold; font-size: 1em;" id="firstHeading" class="firstHeading">' + obj.titulocrib + '</h1></a><div id="bodyContent"><img style="max-width:200px;" src="' + obj.imagenprincipalcrib + '"></div>';
