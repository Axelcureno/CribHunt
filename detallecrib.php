                    ...
                    <div class="frame">
                        <div class="bit-2">
                            <div class="imagen-principal-crib">
                                <a class="fancy-img" href="<?php echo $cribArray[0]["imagenprincipalcrib"]; ?>"><img src="<?php echo $cribArray[0]["imagenprincipalcrib"]; ?>" alt=""></a>
                            </div>
                        ...
                        <div class="bit-2">
                            <div class="linea-prop-crib">
                                ...
                                <div class="elemento-crib">$<?php echo $cribArray[0]["preciocrib"]; ?></div>
                            </div>
                            <div class="linea-prop-crib">
